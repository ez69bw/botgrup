...
@Client.on_message(command(["pause", "j"]) & other_filters)
@errors
...
@Client.on_message(command(["resume", "r"]) & other_filters)
@errors
@authorized_users_only
...
async def stop(_, message: Message):
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_text("❕ **Lagu Dihentikan Dari VCG!**")


@Client.on_message(command(["skip", "next", "n"]) & other_filters)
@errors
@authorized_users_only
