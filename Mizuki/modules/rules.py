...
GET_RULES_HANDLER = CommandHandler(
    "rules", get_rules, filters=Filters.groups, run_async=True
)
SET_RULES_HANDLER = CommandHandler(
    "setrules", set_rules, filters=Filters.groups, run_async=True
)
RESET_RULES_HANDLER = CommandHandler(
    "clearrules", clear_rules, filters=Filters.groups, run_async=True
)
