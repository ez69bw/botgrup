...
def totranslate(update: Update, context: CallbackContext):
    ...
    try:
        ...
        update.effective_message.reply_text(
            ...
            "Example: `/tr en-id` to translate from English to Indonesia\n"
            "Or use: `/tr id` for automatic detection and translating it into Indonesia.\n"
