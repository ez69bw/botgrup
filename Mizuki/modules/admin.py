...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    bot.sendMessage(
        chat.id,
        f"Promote <b>{mention_html(member.user.id, html.escape(member.user.first_name))}</b> berhasil!",
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        bot.sendMessage(
            chat.id,
            f"demote <b>{mention_html(member.user.id, html.escape(member.user.first_name))}</b> berhasil!",
            parse_mode=ParseMode.HTML,
        )
